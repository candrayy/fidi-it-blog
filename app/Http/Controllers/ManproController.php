...
class ManproController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $postingan = DB::table('penanda_postingan')
                ...
                ->where('penanda_postingan.penanda_id', 5)
                ->orderBy('postingan.id', 'desc')
                ->get();
       
        // dd($postingan);
        return view('kategori.it-development.manpro', compact('postingan', 'kategori', 'penanda', 'post'));
    }
