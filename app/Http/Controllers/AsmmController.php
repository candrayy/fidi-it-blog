...
class AsmmController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $postingan = DB::table('penanda_postingan')
                ...
                ->where('penanda_postingan.penanda_id', 6)
                ->orderBy('postingan.id', 'desc')
                ->get();
       
        // dd($postingan);
        return view('kategori.digital-marketing.asmm', compact('postingan', 'kategori', 'penanda', 'post'));
    }
