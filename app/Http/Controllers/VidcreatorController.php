...
class VidcreatorController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $postingan = DB::table('penanda_postingan')
                ...
                ->where('penanda_postingan.penanda_id', 11)
                ->orderBy('postingan.id', 'desc')
                ->get();
       
        // dd($postingan);
        return view('kategori.digital-creative.vidcreator', compact('postingan', 'kategori', 'penanda', 'post'));
    }
