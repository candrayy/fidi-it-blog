...
<head>
  ...
  <title>Blog - Strategic Digital Marketing Distribution Content</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/css/all.css" integrity="sha384-DyZ88mC6Up2uqS4h/KRgHuoeGwBcD4Ng9SiP4dIRy0EXTlnuz47vAwmeGwVChigm" crossorigin="anonymous">
  <link href="assets/blog/img/icon.png" rel="icon">
  <link href="assets/blog/img/icon.png" rel="img">
...
<body>
  ...
  <header id="header" class="header fixed-top">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="{{ route('beranda') }}" class="logo d-flex align-items-center">
        <img src="assets/blog/img/icon.png" alt="">
        <span>Fidi IT Kreatif</span>
      </a>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="" href="{{ route('beranda') }}">Home</a></li>
          ...
          <li class="dropdown"><a href="{{ route('digital-marketing') }}"><span>Digital Marketing</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">Audit Social Media Marketing</a></li>
              <li><a href="#">Strategic Digital Marketing Plan Content</a></li>
              <li><a href="#">Audit Content Marketing</a></li>
              <li><a href="#">Strategic Digital Marketing Distribution Content</a></li>
            </ul>
          </li>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              <div class="entry-img">
                <img src="{{ asset('images/'.$posting->gambar ) }}" alt="" class="img-fluid">
              </div>

              <h2 class="entry-title">
                <a href="#">{{ $posting->judul }}</a>
              </h2>

              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a>{{ $posting->penulis }}</a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a><time datetime="2020-01-01">{{ $posting->created_add }}</time></a></li>
                  <li class="d-flex align-items-center"><i class="bi bi-folder"></i> <a>{{ $posting->kategori }}</a></li>
                </ul>
              </div>

              <div class="entry-content">
                <p>
                {!! Str::limit($posting->isi, 250) !!}
                </p>
                <div class="read-more">
                  <a href="{{ url('detail', $posting->slug) }}">Baca Selengkapnya</a>
                </div>
              </div>
            </article>
            @endforeach
  ...
  <!-- Vendor JS Files -->
  <script src="assets/blog/vendor/purecounter/purecounter.js"></script>
