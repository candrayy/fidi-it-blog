    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a href="{{ route('it-development') }}"><span>IT Development</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
            ...
            <article class="entry">
              ...
              <div class="entry-meta">
                <ul>
                  ...
                  <li class="d-flex align-items-center"><i class="bi bi-folder"></i> <a>{{ $posting->kategori->kategori }}</a></li>
                </ul>
              </div>
