      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 entries">
            ...
            <div class="entry-img">
                <img src="{{ asset('images/'. $detail->gambar ) }}" alt="" class="img-fluid">
            </div>
            ...
            <div class="entry-meta">
                <ul>
                    <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="#">{{ $detail->penulis }}</a></li>
                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="#"><time datetime="2020-01-01">{{ $detail->created_add }}</time></a></li>
                </ul>
            </div>
            ...
            <div class="entry-footer">
                ...
                <ul class="cats">
                    <li><a href="#">{{ $detail->kategori->kategori }}</a></li>
                </ul>

                <i class="bi bi-tags"></i>
                <ul class="tags">
                  @foreach ($detail->penanda as $tags)
                    <li><a href="#">{{ $tags->penanda }}</a></li>
                  @endforeach
                </ul>
            </div>
