...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <!-- Page content -->
    <div class="card-body">
        <h1 class="mb-4">Tambah Data Postingan</h1>
        <form action="{{ route('simpan-postingan') }}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
            ...
            <div class="form-group">
                ...
                <input type="text" id="judul" name="judul" class="form-control" placeholder="Masukan Judul Post" required>
            </div>
            <div class="form-group">
                <label for="penulis" class="form-label">Penulis Post</label>
                <input type="text" id="penulis" name="penulis" class="form-control" placeholder="Masukan Penulis Post" required>
            </div>
            <div class="form-group">
                <label for="created_add" class="form-label">Dibuat Tanggal</label>
                <input type="date" id="created_add" name="created_add" class="form-control" min="1990-01-01" max="2050-01-01" placeholder="dd-mm-yyyy" required>
            </div>
            <div class="form-group">
                <label for="isi" class="form-label">Isi Post</label>
                <textarea type="text" id="isi" name="isi" class="form-control" placeholder="Masukan Isi Post" required></textarea>
            </div>
            <div class="form-group">
            ...
            <label for="select2Multiple">Penanda</label>
              <select class="select2-multiple form-control" name="penanda[]" multiple="multiple"
                id="select2Multiple">
                    ...
                    <option value="{{ $item->id }}">{{ $item->penanda }}</option>
                    @endforeach
                    </select>
            </div>
            <div class="form-group">
