    ...
    <div class="header bg-primary pb-3 pt-3">
      <div class="container-fluid">
        <div class="header-body">
            <a href="{{ route('tambah-kategori') }}" class="btn btn-icon btn-secondary" type="button">
                Tambah Data
            </a>
        </div>
      </div>
            ...
            <div>
                ...
                <thead class="thead-light">
                    <tr>
                        ...
                        <th scope="col" class="sort" data-sort="kode">Kode Kategori</th>
                        <th scope="col" class="sort" data-sort="kategori">Nama Kategori</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>{{ $item->kategori }}</td>
                        <td>
                          <a href="{{ route('edit-kategori', $item->id) }}" type="button" class="btn btn-success btn-sm"><span>Ubah</span></a>
                          <a href="{{ route('hapus-kategori', $item->id) }}" type="button" class="btn btn-danger btn-sm"><span>Hapus</span></span></a>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
