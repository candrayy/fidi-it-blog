...
<head>
  ...
  <title>Admin - Ubah Penanda</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <!-- Page content -->
    <div class="card-body">
        <h1 class="mb-4">Ubah Data Penanda</h1>
        <form action="{{ route('ubah-penanda',$ubahPenanda->id) }}" method="post">
        {{ csrf_field() }}
            <div class="form-group">
                <label for="kd_penanda" class="form-label">Kode Penanda</label>
                <input type="text" id="kd_penanda" name="kd_penanda" value="{{$ubahPenanda->kd_penanda}}" class="form-control" placeholder="Masukan Kode Penanda" required>
            </div>
            <div class="form-group">
                <label for="penanda" class="form-label">Nama Penanda</label>
                <input type="text" id="penanda" name="penanda" value="{{$ubahPenanda->penanda}}" class="form-control" placeholder="Masukan Nama Penanda" required>
            </div>
            <div class="form-group">
