...
<body>
  ...
  <div class="main-content" id="panel">
    ...
    <!-- Header -->
    <!-- Header -->
    <div class="header bg-primary pb-5 pt-5">
      <div class="container-fluid">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      ...
                      <span class="h2 font-weight-bold mb-0">{{$postingan}}</span>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-6">
              <div class="card card-stats">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Penanda</h5>
                      <span class="h2 font-weight-bold mb-0">{{$penanda}}</span>
                    </div>
                    <div class="col-auto">
